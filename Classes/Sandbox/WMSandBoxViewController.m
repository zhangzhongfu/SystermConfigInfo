...
#import "WMDatabaseListController.h"

@interface WMSandBoxViewController () <UITableViewDelegate, UITableViewDataSource>
...
- (UITableView *)tableView {
    if (!_tableView) {
        CGRect frame = CGRectMake(0.0f, kBdbsNavigationBarAndStatusBarHeight, ScreenWidth, ScreenHeight - kBdbsNavigationBarAndStatusBarHeight);
